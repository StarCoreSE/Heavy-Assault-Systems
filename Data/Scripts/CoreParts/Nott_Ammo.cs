...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef HAS_Nott_Ammo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 5f, //
                        Width = 0.8f, //
                        Color = Color(red: 0f, green: 14f, blue: 14f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        Color = Color(red: 0f, green: 14f, blue: 14f, alpha: 1),
                        Back = false,
                        CustomWidth = 0,
