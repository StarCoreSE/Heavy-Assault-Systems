...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition HAS_Nott => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "HAS_Nott", // Block Subtypeid. Your Cubeblocks contain this information
                        SpinPartId = "None", // For weapons with a spinning barrel such as Gatling Guns.
                        MuzzlePartId = "AMSOrby_Ele", // The subpart where your muzzle empties are located. This is often the elevation subpart.
                        AzimuthPartId = "AMSOrby_Rot", // Your Rotating Subpart, the bit that moves sideways
                        ElevationPartId = "AMSOrby_Ele",// Your Elevating Subpart, that bit that moves up
                ...
                Muzzles = new[] {
                    "Muzzle_AMSOrby_01", // Where your Projectiles spawn. Use numbers not Letters. IE Muzzle_01 not Muzzle_A
                },
                Ejector = "", // Optional; empty from which to eject "shells" if specified.
                Scope = "Camera_AMSOrby", // Where line of sight checks are performed from. Must be clear of block collision.
            },
            ...
            {
                PartName = "Nott", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Graphics = new HardPointParticleDef
                {
                    ...
                    {
                        Name = "K_SA_Explosion_I", // SubtypeId of muzzle particle effect.
            ...
            Ammos = new[] {
                HAS_Nott_Ammo, // Must list all primary, shrapnel, and pattern ammos.
            },
